...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
        ...
        _gsScope._gsDefine("utils.Draggable", ["events.EventDispatcher", "TweenLite", "plugins.CSSPlugin"], function (a, b, c) {
            var d, e, f, g, h, i, j, k, l, m = {
                ...
                , Aa = function (a, b, c, d) {
                    ...
                    var e, f, h, i, l, m, n, o, p, q, r, s, v, w, x = a._dCache || za(a)
                        , y = a.parentNode
                        , z = y._dCache || za(y)
                        , A = x.computedStyle
                        , B = x.isSVG ? z.offsetParent : y.offsetParent;
                    return e = x.isSVG && -1 !== (a.style[oa] + "").indexOf("matrix") ? a.style[oa] : A ? A.getPropertyValue(pa) : a.currentStyle ? a.currentStyle[oa] : "1,0,0,1,0,0", a.getBBox && -1 !== (a.getAttribute("transform") + "").indexOf("matrix") && (e = a.getAttribute("transform")), e = (e + "").match(/(?:\-|\.|\b)(\d|\.|e\-)+/g) || [1, 0, 0, 1, 0, 0], e.length > 6 && (e = [e[0], e[1], e[4], e[5], e[12], e[13]]), d ? e[4] = e[5] = 0 : x.isSVG && (l = a._gsTransform) && (l.xOrigin || l.yOrigin) && (e[0] = parseFloat(e[0]), e[1] = parseFloat(e[1]), e[2] = parseFloat(e[2]), e[3] = parseFloat(e[3]), e[4] = parseFloat(e[4]) - (l.xOrigin - (l.xOrigin * e[0] + l.yOrigin * e[2])), e[5] = parseFloat(e[5]) - (l.yOrigin - (l.xOrigin * e[1] + l.yOrigin * e[3]))), b && (void 0 === g && la(), h = x.isSVG || x.isSVGRoot ? xa(a) : a, x.isSVG ? (i = a.getBBox(), q = z.isSVGRoot ? {
                        x: 0
                        , y: 0
                    } : y.getBBox(), h = {
                        offsetLeft: i.x - q.x
                ...
                , Ta = function (d, g) {
                    ...
                    var h, i, j, k, l, r, s, v, w, y, E, H, P, S, U, V, Z, ba, da, ea, fa, ga, ha, la, ma, na, oa, pa, qa, ra, sa, ta, ua, va, wa = (g.type || (C ? "top,left" : "x,y")).toLowerCase()
                        , xa = -1 !== wa.indexOf("x") || -1 !== wa.indexOf("y")
                        , ya = -1 !== wa.indexOf("rotation")
                        , za = ya ? "rotation" : xa ? "x" : "left"
                        , Aa = xa ? "y" : "top"
                        , Da = -1 !== wa.indexOf("x") || -1 !== wa.indexOf("left") || "scroll" === wa
                        , Ea = -1 !== wa.indexOf("y") || -1 !== wa.indexOf("top") || "scroll" === wa
                        ...
                        , cb = function (a, b) {
                            ...
                            a && f ? (a === !0 && (c = g.snap || g.liveSnap || {}, e = c instanceof Array || "function" == typeof c, a = {
                                resistance: (g.throwResistance || g.resistance || 1e3) / (ya ? 10 : 1)
                            }, ya ? a.rotation = Oa(Ga, e ? c : c.rotation, w, y, 1, b) : (Da && (a[za] = Oa(Ga, e ? c : c.points || c.x || c.left || c.scrollLeft, w, y, i ? -1 : 1, b || "x" === Ga.lockedAxis)), Ea && (a[Aa] = Oa(Ga, e ? c : c.points || c.y || c.top || c.scrollTop, E, H, i ? -1 : 1, b || "y" === Ga.lockedAxis)), (c.points || c instanceof Array && "object" == typeof c[0]) && (a.linkedProps = za + "," + Aa, a.radius = c.radius))), Ga.isThrowing = !0, j = isNaN(g.overshootTolerance) ? 1 === g.edgeResistance ? 0 : 1 - Ga.edgeResistance + .2 : g.overshootTolerance, Ga.tween = h = f.to(i || d, {
                                throwProps: a
                                , ease: g.ease || q.Power3.easeOut
                                , onComplete: ab
                                , onOverwrite: bb
                                , onUpdate: g.fastMode ? ja : $a
                                , onUpdateParams: g.fastMode ? [Ga, "onthrowupdate", "onThrowUpdate"] : c && c.radius ? [!1, !0] : x
                            }, isNaN(g.maxDuration) ? 2 : g.maxDuration, isNaN(g.minDuration) ? 0 === j ? 0 : .5 : g.minDuration, j), g.fastMode || (i && (i._suspendTransforms = !0), h.render(h.duration(), !0, !0), $a(!0, !0), Ga.endX = Ga.x, Ga.endY = Ga.y, ya && (Ga.endRotation = Ga.x), h.play(0), $a(!0, !0), i && (i._suspendTransforms = !1))) : s && Ga.applyBounds()
                        }
                        , db = function (a) {
                            var b, c, e, f, g, h, i, l, m, n = ma || [1, 0, 0, 1, 0, 0];
                            ma = Ba(d.parentNode, !0), a && Ga.isPressed && n.join(",") !== ma.join(",") && (b = n[0], c = n[1], e = n[2], f = n[3], g = n[4], h = n[5], i = b * f - c * e, l = j * (f / i) + k * (-e / i) + (e * h - f * g) / i, m = j * (-c / i) + k * (b / i) + -(b * h - c * g) / i, k = l * ma[1] + m * ma[3] + ma[5], j = l * ma[0] + m * ma[2] + ma[4]), ma[1] || ma[2] || 1 != ma[0] || 1 != ma[3] || 0 != ma[4] || 0 != ma[5] || (ma = null)
                        }
                        , eb = function () {
                            var a = 1 - Ga.edgeResistance;
                            db(!1), ma && (j = Ga.pointerX * ma[0] + Ga.pointerY * ma[2] + ma[4], k = Ga.pointerX * ma[1] + Ga.pointerY * ma[3] + ma[5]), ba && (lb(Ga.pointerX, Ga.pointerY), Za(!0)), i ? (_a(), r = i.top(), l = i.left()) : (fb() ? ($a(!0, !0), _a()) : Ga.applyBounds(), ya ? (Z = Ca(d, {
                                x: 0
                                , y: 0
                            }), $a(!0, !0), l = Ga.x, r = Ga.y = Math.atan2(Z.y - Ga.pointerY, Ga.pointerX - Z.x) * z) : (oa = d.parentNode ? d.parentNode.scrollTop || 0 : 0, pa = d.parentNode ? d.parentNode.scrollLeft || 0 : 0, r = ia(d, Aa), l = ia(d, za))), s && a && (l > w ? l = w + (l - w) / a : y > l && (l = y - (y - l) / a), ya || (r > E ? r = E + (r - E) / a : H > r && (r = H - (H - r) / a))), Ga.startX = l, Ga.startY = r, ya && (Ga.start.rotation = l)
                        }
                        , fb = function () {
                            return Ga.tween && Ga.tween.isActive()
                        }
                        , gb = function () {
                            !D.parentNode || fb() || Ga.isDragging || D.parentNode.removeChild(D)
                        }
                        , hb = function (a, b, c, d) {
                            return "function" == typeof a ? function (e) {
                                var f = Ga.isPressed ? 1 - Ga.edgeResistance : 1;
                                return a.call(Ga, e > c ? c + (e - c) * f : b > e ? b + (e - b) * f : e) * d
                        ...
                        , ib = function (a, b, c, d, e, f, g) {
                            return f = f || A, "function" == typeof a ? function (h) {
                                var i, j, k, l = Ga.isPressed ? 1 - Ga.edgeResistance : 1
                                    , m = h.x
                                    , n = h.y;
                                return h.x = m = m > c ? c + (m - c) * l : b > m ? b + (m - b) * l : m, h.y = n = n > e ? e + (n - e) * l : d > n ? d + (n - d) * l : n, i = a.call(Ga, h), i !== h && (h.x = i.x, h.y = i.y), 1 !== g && (h.x *= g, h.y *= g), A > f && (j = h.x - m, k = h.y - n, Math.sqrt(j * j + k * k) > f && (h.x = m, h.y = n)), h
                            } : a instanceof Array ? function (b) {
                                for (var c, d, e, g, h = a.length, i = 0, j = A; --h > -1;) e = a[h], c = e.x - b.x, d = e.y - b.y, g = Math.sqrt(c * c + d * d), j > g && (i = h, j = g);
                                return f >= j ? a[i] : b
                            } : function (a) {
                                return a
                            }
                        ...
                        , kb = function (a) {
                            ...
                            if (h && !e && Ga.isPressed && a) {
                                ...
                                if (C) a = _(a, !0);
                                    ...
                                    if (la && ra && !sa && (c = a.pageX, d = a.pageY, ma && (f = c * ma[0] + d * ma[2] + ma[4], d = c * ma[1] + d * ma[3] + ma[5], c = f), g = Math.abs(c - j), i = Math.abs(d - k), (g !== i && (g > Fa || i > Fa) || J && ra === sa) && (sa = g > i && Da ? "x" : "y", Ga.vars.lockAxisOnTouchScroll !== !1 && (Ga.lockedAxis = "x" === sa ? "y" : "x", "function" == typeof Ga.vars.onLockAxis && Ga.vars.onLockAxis.call(Ga, l)), J && ra === sa))) return void mb(l);
                                    Ga.allowEventDefault || ra && (!sa || ra === sa) || l.cancelable === !1 || (l.preventDefault(), l.preventManipulation && l.preventManipulation())
                                }
                                Ga.autoScroll && (Va = !0), lb(a.pageX, a.pageY)
                            }
                        }
                        , lb = function (a, b) {
                            var c, d, e, f, g, h, i = 1 - Ga.dragResistance
                                , m = 1 - Ga.edgeResistance;
                            Ga.pointerX = a, Ga.pointerY = b, ya ? (f = Math.atan2(Z.y - b, a - Z.x) * z, g = Ga.y - f, Ga.y = f, g > 180 ? r -= 360 : -180 > g && (r += 360), e = l + (r - f) * i) : (ma && (h = a * ma[0] + b * ma[2] + ma[4], b = a * ma[1] + b * ma[3] + ma[5], a = h), d = b - k, c = a - j, Fa > d && d > -Fa && (d = 0), Fa > c && c > -Fa && (c = 0), (Ga.lockAxis || Ga.lockedAxis) && (c || d) && (h = Ga.lockedAxis, h || (Ga.lockedAxis = h = Da && Math.abs(c) > Math.abs(d) ? "y" : Ea ? "x" : null, h && "function" == typeof Ga.vars.onLockAxis && Ga.vars.onLockAxis.call(Ga, Ga.pointerEvent)), "y" === h ? d = 0 : "x" === h && (c = 0)), e = l + c * i, f = r + d * i), (ea || fa || ga) && (Ga.x !== e || Ga.y !== f && !ya) ? (ga && (L.x = e, L.y = f, h = ga(L), e = h.x, f = h.y), ea && (e = ea(e)), fa && (f = fa(f))) : s && (e > w ? e = w + (e - w) * m : y > e && (e = y + (e - y) * m), ya || (f > E ? f = E + (f - E) * m : H > f && (f = H + (f - H) * m))), ya || (e = Math.round(e), f = Math.round(f)), (Ga.x !== e || Ga.y !== f && !ya) && (ya ? (Ga.endRotation = Ga.x = Ga.endX = e, ba = !0) : (Ea && (Ga.y = Ga.endY = f, ba = !0), Da && (Ga.x = Ga.endX = e, ba = !0)), !Ga.isDragging && Ga.isPressed && (Ga.isDragging = !0, ja(Ga, "dragstart", "onDragStart")))
                        }
                        , mb = function (a, c) {
                            if (h && Ga.isPressed && (!a || null == V || c || !(a.pointerId && a.pointerId !== V || a.changedTouches && !La(a.changedTouches, V)))) {
                                Ga.isPressed = !1;
                                var e, f, i, j, k, l = a
                                    , m = Ga.isDragging
                                    , n = b.delayedCall(.001, gb);
                                if (la ? (Ka(la, "touchend", mb), Ka(la, "touchmove", kb), Ka(la, "touchcancel", mb), Ka(t, "touchstart", Na)) : Ka(t, "mousemove", kb), Ka(t, "mouseup", mb), a && a.target && Ka(a.target, "mouseup", mb), ba = !1, ha) return a && Ka(a.target, "change", mb), Qa(Ma, !1), ja(Ga, "release", "onRelease"), ja(Ga, "click", "onClick"), void(ha = !1);
                                if (R(Za), !ya)
                                    for (f = Ma.length; --f > -1;) ca(Ma[f], "cursor", g.cursor || "move");
                                if (m && (Ua = K = B(), Ga.isDragging = !1), I--, a) {
                                    ...
                                    Ga.pointerEvent = l, Ga.pointerX = a.pageX, Ga.pointerY = a.pageY
                                }
                                return l && !m ? (na && (g.snap || g.bounds) && cb(g.throwProps), ja(Ga, "release", "onRelease"), J && "touchmove" === l.type || (ja(Ga, "click", "onClick"), j = l.target || l.srcElement || d, Ya = B(), k = function () {
                                    Ya !== ua && Ga.enabled() && !Ga.isPressed && (j.click ? j.click() : t.createEvent && (i = t.createEvent("MouseEvents"), i.initMouseEvent("click", !0, !0, window, 1, Ga.pointerEvent.screenX, Ga.pointerEvent.screenY, Ga.pointerX, Ga.pointerY, !1, !1, !1, !1, 0, null), j.dispatchEvent(i)))
                                }, J || l.defaultPrevented || b.delayedCall(1e-5, k))) : (cb(g.throwProps), C || Ga.allowEventDefault || !l || !g.dragClickables && Wa.call(Ga, l.target) || !m || ra && (!sa || ra !== sa) || l.cancelable === !1 || (l.preventDefault(), l.preventManipulation && l.preventManipulation()), ja(Ga, "release", "onRelease")), fb() && n.duration(Ga.tween.duration()), m && ja(Ga, "dragend", "onDragEnd"), !0
                            }
                        }
                        , nb = function (a) {
                            if (a && Ga.isDragging && !i) {
                                ...
                                (c || e) && (ma ? (j -= c * ma[0] + e * ma[2], k -= e * ma[3] + c * ma[1]) : (j -= c, k -= e), b._gsScrollX += c, b._gsScrollY += e, lb(Ga.pointerX, Ga.pointerY))
                            }
                        }
                        , ob = function (a) {
                            var b = B()
                            ...
                            return f && (e || d && Ga.vars.suppressClickOnDrag !== !1) && a.stopImmediatePropagation(), !c || Ga.pointerEvent && Ga.pointerEvent.defaultPrevented || e && i === h ? void((Ga.isPressed || d || c) && (f ? i && a.detail && c && !g || (a.preventDefault(), a.preventManipulation && a.preventManipulation()) : a.returnValue = !1)) : (i && e && (va = Ya), void(ua = Ya))
                        };
                    da = Ta.get(this.target), da && da.kill(), this.startDrag = function (a) {
                        jb(a), Ga.isDragging || (Ga.isDragging = !0, ja(Ga, "dragstart", "onDragStart"))
                    }, this.drag = kb, this.endDrag = function (a) {
                        mb(a, !0)
                        ...
                        var c, d, e, g, h, i, j = "velocity" === a && f ? a : "object" != typeof a || ya ? "start" : "element";
                        return "element" === j && (h = Xa(Ga.target), i = Xa(a)), c = "start" === j ? Ga.x - l : "velocity" === j ? f.getVelocity(this.target, za) : h.left + h.width / 2 - (i.left + i.width / 2), ya ? 0 > c ? "counter-clockwise" : "clockwise" : (b = b || 2, d = "start" === j ? Ga.y - r : "velocity" === j ? f.getVelocity(this.target, Aa) : h.top + h.height / 2 - (i.top + i.height / 2), e = Math.abs(c / d), g = 1 / b > e ? "" : 0 > c ? "left" : "right", b > e && ("" !== g && (g += "-"), g += 0 > d ? "up" : "down"), g)
                    }, this.applyBounds = function (a) {
                        var b, c, e, f, h, i;
                        if (a && g.bounds !== a) return g.bounds = a, Ga.update(!0);
                        if ($a(!0), _a(), s) {
                            if (b = Ga.x, c = Ga.y, b > w ? b = w : y > b && (b = y), c > E ? c = E : H > c && (c = H), (Ga.x !== b || Ga.y !== c) && (e = !0, Ga.x = Ga.endX = b, ya ? Ga.endRotation = b : Ga.y = Ga.endY = c, ba = !0, Za(!0), Ga.autoScroll && !Ga.isDragging))
                            ...
                            Ga.isThrowing && (e || Ga.endX > w || Ga.endX < y || Ga.endY > E || Ga.endY < H) && cb(g.throwProps, e)
                        }
                        return Ga
                    }, this.update = function (a, b, c) {
                        var e = Ga.x
                            , f = Ga.y;
                        return db(!b), a ? Ga.applyBounds() : (ba && c && Za(!0), $a(!0)), b && (lb(Ga.pointerX, Ga.pointerY), ba && Za(!0)), Ga.isPressed && !b && (Da && Math.abs(e - Ga.x) > .01 || Ea && Math.abs(f - Ga.y) > .01 && !ya) && eb(), Ga.autoScroll && ($(d.parentNode), Va = Ga.isDragging, Za(!0)), Ga.autoScroll && (X(d, nb), W(d, nb)), Ga
                    }, this.enable = function (a) {
                        var e, j, k;
                        if ("soft" !== a) {
                            for (j = Ma.length; --j > -1;) k = Ma[j], Ja(k, "mousedown", jb), Ja(k, "touchstart", jb), Ja(k, "click", ob, !0), ya || ca(k, "cursor", g.cursor || "move"), ca(k, "touchCallout", "none"), ca(k, "touchAction", Da === Ea ? "none" : Da ? "pan-y" : "pan-x");
                            Qa(Ma, !1)
                        }
                        return W(d, nb), h = !0, f && "soft" !== a && f.track(i || d, xa ? "x,y" : ya ? "rotation" : "top,left"), i && i.enable(), d._gsDragID = e = "d" + G++, F[e] = this, i && (i.element._gsDragID = e), b.set(d, {
                            x: "+=0"
                            , overwrite: !1
                        }), qa = {
                            t: d
                        ...
                        var b, c, e = Ga.isDragging;
                        if (!ya)
                            for (b = Ma.length; --b > -1;) ca(Ma[b], "cursor", null);
                        if ("soft" !== a) {
                            for (b = Ma.length; --b > -1;) c = Ma[b], ca(c, "touchCallout", null), ca(c, "touchAction", null), Ka(c, "mousedown", jb), Ka(c, "touchstart", jb), Ka(c, "click", ob);
                            Qa(Ma, !0), la && (Ka(la, "touchcancel", mb), Ka(la, "touchend", mb), Ka(la, "touchmove", kb)), Ka(t, "mouseup", mb), Ka(t, "mousemove", kb)
                        }
                        return X(d, nb), h = !1, f && "soft" !== a && f.untrack(i || d, xa ? "x,y" : ya ? "rotation" : "top,left"), i && i.disable(), R(Za), Ga.isDragging = Ga.isPressed = ha = !1, e && ja(Ga, "dragend", "onDragEnd"), Ga
                    }, this.enabled = function (a, b) {
                        return arguments.length ? a ? Ga.enable(b) : Ga.disable(b) : h
                    }, this.kill = function () {
                        return Ga.isThrowing = !1, b.killTweensOf(i || d, !0, Ra), Ga.disable(), delete F[d._gsDragID], Ga
                    }, -1 !== wa.indexOf("scroll") && (i = this.scrollProxy = new Sa(d, T({
                        onKill: function () {
                            Ga.isPressed && mb(null)
                        }
                    }, g)), d.style.overflowY = Ea && !Ha ? "auto" : "hidden", d.style.overflowX = Da && !Ha ? "auto" : "hidden", d = i.content), g.force3D !== !1 && b.set(d, {
                        force3D: !0
                    }), ya ? Ra.rotation = 1 : (Da && (Ra[za] = 1), Ea && (Ra[Aa] = 1)), ya ? (P = p, S = P.css, P.overwrite = !1) : xa && (P = Da && Ea ? m : Da ? n : o, S = P.css, P.overwrite = !1), this.enable()
                }
                , Ua = Ta.prototype = new a;
            Ua.constructor = Ta, Ua.pointerX = Ua.pointerY = Ua.startX = Ua.startY = Ua.deltaX = Ua.deltaY = 0, Ua.isDragging = Ua.isPressed = !1, Ta.version = "0.15.0", Ta.zIndex = 1e3, Ja(t, "touchcancel", function () {}), Ja(t, "contextmenu", function (a) {
                var b;
    ...
    , function (a) {
        ...
        "function" == typeof define && define.amd ? define(["TweenLite", "CSSPlugin"], b) : "undefined" != typeof module && module.exports && (require("../TweenLite.min.js"), require("../plugins/CSSPlugin.min.js"), module.exports = b())
    }("Draggable");